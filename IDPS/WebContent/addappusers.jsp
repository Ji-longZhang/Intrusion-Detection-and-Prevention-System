...
<div class="clsTopNavigation clsFloatRight">
	<ul>
		...
		<li class="clsActive"><a href="addappusers.jsp">Users</a></li>
...
<div id="content" class="clearfix">
	...
	<div id="main">
		<div class="clsContact">
			<h2>
				Application User<span> Form</span>
			</h2>
		...
		<div class="clsMain_Bottom clearfix clsNoBorder">
			<div class="clsMain_BottomLeft clsFloatLeft clsNoBorder">
				...
				%>
					<form name="appForm" action="MainController?action=addapplicationUser" method=post>
							<%
					...
					<p>
						<input type="text" name="userRole" size="30" required/>
					</p>
